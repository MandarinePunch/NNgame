...
public class GameDTO {
	...
	public int getGame_agelimit() {
		return game_agelimit;
	}
	public void setGame_agelimit(int game_agelimit) {
		this.game_agelimit = game_agelimit;
	}
